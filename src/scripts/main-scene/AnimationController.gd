...
onready var welcome = get_node("Welcome/WelcomeImage")
onready var header = get_node("Header")
onready var footer = get_node("Footer")
onready var button = get_node("Footer/WHOOPS Footer/WHOOPS Button")
onready var world = get_node("Worlds")
